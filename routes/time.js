...
router.put('/entries/:id', adminRequired, (req, res) => {
...
router.delete('/entries/:id', adminRequired, (req, res) => {
  const e = db.prepare('SELECT * FROM time_entries WHERE id = ?').get(req.params.id);
...
router.get('/payroll', adminRequired, (req, res) => {
...
router.post('/status-marks', adminRequired, (req, res) => {
...
router.get('/status-marks', adminRequired, (req, res) => {
...
router.delete('/status-marks/:id', adminRequired, (req, res) => {
...
router.get('/attendance-summary', adminRequired, (req, res) => {
...
router.get('/schedule-exceptions', adminRequired, (req, res) => {
...
router.put('/schedule-exceptions/:id/review', adminRequired, (req, res) => {
  const exc = db.prepare('SELECT * FROM schedule_exceptions WHERE id = ?').get(req.params.id);
  if (!exc) return res.status(404).json({ error: 'Not found' });

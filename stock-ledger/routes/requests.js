...
router.get('/availability', requirePermission('approve_leave_availability'), (req, res) => {
  const week = req.query.week || nextMondayISO();
...
router.get('/leave', requirePermission('approve_leave_availability'), (req, res) => {
...
router.put('/leave/:id', requirePermission('approve_leave_availability'), (req, res) => {
...
router.get('/feedback', requirePermission('manage_team'), (req, res) => {
...
router.put('/feedback/:id', requirePermission('manage_team'), (req, res) => {
